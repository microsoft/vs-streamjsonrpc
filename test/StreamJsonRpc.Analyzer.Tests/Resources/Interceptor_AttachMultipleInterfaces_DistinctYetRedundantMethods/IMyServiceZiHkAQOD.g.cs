	...
	, global::IMyService2
{
	...
	global::System.Threading.Tasks.Task global::IMyService2.Task1(string name)
	{
		...
		global::System.Threading.Tasks.Task result = this.Options.ServerRequiresNamedArguments ?
		    this.JsonRpc.InvokeWithParameterObjectAsync(rpcMethodName, new Task1NamedArgs2(name), null, default) :
	...
	private readonly struct Task1NamedArgs2
	{
	    public Task1NamedArgs2(string name)
	    {
			this.name = name;
		}
